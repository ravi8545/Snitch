      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-8 md:p-16">
        <div className="w-full max-w-md space-y-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-7">
            ...
            <a href="/api/auth/google" className="w-full  text-white py-3.5 text-sm font-semibold tracking-wider uppercase hover:bg-[#3367D6] transition-colors duration-200 cursor-pointer">
